...
public class ReceiveHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        topAnimation = AnimationUtils.loadAnimation(ReceiveHistory.this, R.anim.splash_top_animation);
        bottomAnimation = AnimationUtils.loadAnimation(ReceiveHistory.this, R.anim.splash_bottom_animation);
        startAnimation = AnimationUtils.loadAnimation(ReceiveHistory.this, R.anim.splash_start_animation);
        endAnimation = AnimationUtils.loadAnimation(ReceiveHistory.this, R.anim.splash_end_animation);
